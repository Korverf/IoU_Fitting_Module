...
from iou_fit_conv_bottle_9 import get_model
...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='iou_fit_conv_bottle_9_new')
    parser.add_argument('--iters', default=3000000, type=int)
    ...
    parser.add_argument('--lr', default=1e-4, type=float)#2.5e-5
