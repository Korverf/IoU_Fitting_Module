...
def obb_overlaps(bboxes1, bboxes2, mode='iou', is_aligned=False, device_id=None):
    ...
    if is_aligned:
        ...
        assert bboxes1.shape[1] == bboxes2.shape[1] == 5
...
def aligned_obb_overlaps(bboxes1, bboxes2, mode='iou'):
    ...
    # areas1 = (bboxes1[:, 2] - 1) * (bboxes1[:, 3] - 1)
    # areas2 = (bboxes2[:, 2] - 1) * (bboxes2[:, 3] - 1)
    #bboxes1, bboxes2 = obb2poly(bboxes1), obb2poly(bboxes2)
    bboxes1, bboxes2 = RotBox2Polys_torch(bboxes1), RotBox2Polys_torch(bboxes2)
