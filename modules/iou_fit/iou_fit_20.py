...
class IOUfitModule(nn.Module):
    def __init__(self, in_features, hidden_features=None):
        ...
        self.fc1 = FC(in_channels=in_features, feedforward_channels=1024, out_channels=1024,
                      act_cfg=dict(type='ReLU'), add_residual=False, with_act=True, with_bn=False, drop=0.5)
        self.fc2 = FC(in_channels=1024, feedforward_channels=1024, out_channels=1024,
                      act_cfg=dict(type='ReLU'), add_residual=False, with_act=True, with_bn=False, drop=0.5)
        self.fc3 = FC(in_channels=1024, feedforward_channels=1024, out_channels=1,
